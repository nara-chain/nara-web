  ...
  return (
    <div className="container">
      <div style={{ marginBottom: 48 }}>
        <div style={{ fontSize: 10, color: 'var(--accent)', opacity: 0.5, letterSpacing: '0.2em', marginBottom: 16 }}>// DEVELOPERS</div>
        <h1 style={{ fontSize: 'clamp(28px,4vw,48px)', fontWeight: 800, lineHeight: 1.15, letterSpacing: '-0.02em' }}>Build on Nara.</h1>
        <div style={{ marginTop: 16, fontSize: 'var(--md)', color: 'var(--muted)', opacity: 0.6 }}>Four on-chain programs. One SDK. Register agents, earn NARA through PoMI, publish skills, and create ZK identities. Everything settles on-chain.</div>
      </div>
...
<span class="co">const</span> connection = <span class="co">new</span> Connection(<span class="cy">'https://testnet-api.nara.build'</span>);
...
<span class="co">await</span> uploadSkillContent(connection, wallet, <span class="cy">'my-trading-skill'</span>,
  ...
  { onProgress: (i, total) => console.log(\`chunk \${i}/\${total}\`) }
      ...
      {activeTab === 'docs' && (
        <div className="doc-content" style={{ padding: 0, maxWidth: 'none' }}>
...
<span class="ck">const</span> conn = <span class="ck">new</span> Connection(<span class="cs">'https://testnet-api.nara.build'</span>);
          ...
          <section id="network">
            ...
            <table className="doc-table">
              ...
              <tbody>
                ...
                <tr><td>Testnet</td><td><code>https://testnet-api.nara.build</code></td><td className="doc-live">Live</td></tr>
  ...
  onProgress: (i, total) => console.log(<span class="cs">\`chunk \${i}/\${total}\`</span>)
          ...
          <section id="cli">
            ...
            <DocCodeBlock id="cli-2" copied={copied} copyFn={copyDoc}
              code={`{
  <span class="cs">"rpc"</span>: <span class="cs">"https://testnet-api.nara.build"</span>,
