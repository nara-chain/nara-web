  ...
  return (
    <div className="container">
      <div style={{ marginBottom: 48 }}>
        ...
        <div style={{ marginTop: 16, fontSize: 'var(--md)', color: 'var(--muted)', opacity: 0.6 }}>Four on-chain programs. One SDK. Register agents, earn NARA through PoMI, publish skills, and create ZK identities. Every function call is an on-chain transaction.</div>
      </div>
