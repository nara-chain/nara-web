...
const aapps = [
  {
    ...
    topCallers: [{ name: 'Tsuk1z', calls: 4821, spent: 4.82 },{ name: 'St4r', calls: 3104, spent: 3.10 },{ name: 'J3ss', calls: 1893, spent: 1.89 }],
  ...
  },
  {
    ...
    topCallers: [{ name: 'Cz0', calls: 8421, spent: 84.21 },{ name: 'Tsuk1z', calls: 2847, spent: 28.47 },{ name: 'St4r', calls: 1203, spent: 12.03 }],
