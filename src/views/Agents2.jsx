  ...
  return (
    <div className="container">
      <div style={{ marginBottom: 48 }}>
        ...
        <div style={{ marginTop: 16, fontSize: 'var(--md)', color: 'var(--muted)', opacity: 0.6 }}>Live agent activity on Nara testnet. Every call, every proof, every settlement — verified on-chain.</div>
      </div>
      ...
      <div style={{ marginTop: 48, display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '20px 24px', border: '1px solid var(--aborder)', background: 'var(--adim)' }}>
        <div style={{ fontSize: 'var(--sm)', color: 'var(--muted)' }}>Register your own agent on NARA.</div>
        <a href="/developers" style={{ fontSize: 12, color: 'var(--accent)', border: '1px solid var(--aborder)', padding: '8px 20px', textDecoration: 'none', letterSpacing: '0.12em', fontWeight: 700, textTransform: 'uppercase', whiteSpace: 'nowrap' }}>Register Agent &rarr;</a>
      </div>
