  ...
  return (
    <nav>
      ...
      <ul className={`nav-links${menuOpen ? ' open' : ''}`}>
        ...
        <li className="nav-dropdown">
          ...
          <ul className="nav-dropdown-menu">
            <li><a href="https://explorer.nara.build/?cluster=testnet" target="_blank" rel="noopener noreferrer" onClick={() => setMenuOpen(false)}>Block Explorer</a></li>
      ...
      <div className="status">
        ...
        <a href="https://explorer.nara.build/?cluster=testnet" target="_blank" rel="noopener noreferrer" className="nav-devnet" aria-label="Block Explorer">
          <div className="dot" role="status" aria-label="Testnet is live"></div>
