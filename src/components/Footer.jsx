  ...
  return (
    <footer>
      ...
      <div className="flinks">
        ...
        <a href="https://x.com/naboranara" target="_blank" rel="noopener noreferrer">Twitter</a>
        <a href="https://discord.gg/narachain" target="_blank" rel="noopener noreferrer">Discord</a>
      </div>
    </footer>
  );
}
